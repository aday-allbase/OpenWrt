...
PACKAGES=" cgi-io kmod-mii kmod-usb-net kmod-usb-wdm kmod-usb-net-qmi-wwan uqmi luci-proto-qmi \
...
# Misc
    PACKAGES=" luci-app-ttyd zram-swap adb parted losetup resize2fs luci luci-ssl block-mount htop bash curl wget wget-ssl tar unzip unrar gzip jq nano httping screen openssh-sftp-server"
